...
# These functions are adapted from https://huggingface.co/learn/nlp-course/chapter7/7?fw=pt
...
def compute_metrics(CONFIG, start_logits, end_logits, features, examples):
